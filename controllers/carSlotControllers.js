import { findOne, findById, countDocuments } from '../models/parkingSlot';
import { create, findById as _findById } from '../models/car';
...
export default {enterParkingDetails,allocateRandomSlot,cancelReservation,checkAvailableSlots,};
